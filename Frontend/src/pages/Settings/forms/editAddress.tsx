...
import { ArrowLeft, MapPin, User, Save } from "lucide-react";
import { useUpdateAddressMutation } from "@/features/address/addressApi";
import { toast } from "react-toastify";
import { useEffect } from "react";

type editAddressData = z.infer<typeof addAddressSchema>;
...
const EditAddressForm = () => {
  ...
  const {
    ...
    formState: { errors },
    setValue,
  } = useForm<editAddressData>({ resolver: zodResolver(addAddressSchema) });
  ...
  const onSubmit = async (data: editAddressData) => {
    ...
    try {
      ...
      await updateAddress({ addressId, data: payload }).unwrap();
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50 flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600 mb-4">Address data not found</p>
          <button
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-t-2xl shadow-xl border border-white/20 p-8 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="text-center pt-12">
                <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full mb-6 shadow-lg transform hover:scale-105 transition-transform duration-200">
            ...
            <form className="space-y-8" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold py-5 px-6 rounded-xl hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-200 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed text-lg transform hover:scale-[1.02] active:scale-[0.98]"
                >
                  {isLoading ? (
